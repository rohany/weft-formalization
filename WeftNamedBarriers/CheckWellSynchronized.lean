...
export WeftCommon (mem_transClosure_imp_transGen subset_transClosureStep
  transClosureStep_mono subset_iterate_transClosureStep iterate_transClosureStep_mono
  mem_transClosureStep_iff mem_transClosureStep_of_mem_R mem_iterate_prepend
  mem_iterate_of_isChain nodup_chain_length_le exists_nodup_isChain
